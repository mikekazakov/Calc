...
#define MSG_IMPL_4(r, obj, sel, a, b, c, d) \
  ((r (*)(id, SEL, __typeof__(a), __typeof__(b), __typeof__(c), __typeof__(d)))objc_msgSend)(obj, sel, (a), (b), (c), (d))
#define MSG_IMPL_N(_4, _3, _2, _1, NAME, ...) NAME
#define MSG(ret, obj, sel, ...) \
  MSG_IMPL_N(__VA_ARGS__ __VA_OPT__(, ) MSG_IMPL_4, MSG_IMPL_3, MSG_IMPL_2, MSG_IMPL_1, MSG_IMPL_0)(ret, obj, sel __VA_OPT__(, ) __VA_ARGS__)
...
#define CLASS_MSG_IMPL_4(r, cls, sel, a, b, c, d) \
  ((r (*)(Class, SEL, __typeof__(a), __typeof__(b), __typeof__(c), __typeof__(d)))objc_msgSend)(cls, sel, (a), (b), (c), (d))
#define CLASS_MSG_IMPL_N(_4, _3, _2, _1, NAME, ...) NAME
#define CLASS_MSG(ret, class, sel, ...)                                                                                                  \
  CLASS_MSG_IMPL_N(__VA_ARGS__ __VA_OPT__(, ) CLASS_MSG_IMPL_4, CLASS_MSG_IMPL_3, CLASS_MSG_IMPL_2, CLASS_MSG_IMPL_1, CLASS_MSG_IMPL_0)( \
      ret, class, sel __VA_OPT__(, ) __VA_ARGS__)
